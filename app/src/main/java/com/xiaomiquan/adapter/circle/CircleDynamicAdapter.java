...
public class CircleDynamicAdapter extends CommonAdapter<SquareLive> {
    ...
    public CircleDynamicAdapter(BaseDataBind baseDataBind, Context context, List<SquareLive> datas) {
