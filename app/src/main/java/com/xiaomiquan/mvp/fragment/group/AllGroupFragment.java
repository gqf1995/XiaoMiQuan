                ...
                public void onClick(View view, int position, Object item) {
                    if (SingSettingDBUtil.getUserLogin() != null) {
                        if (view.getId() == R.id.tv_commit) {
                            ...
                            //SimulatedTradingFragment.startAct(getActivity(), (ArrayList) datas, position, true);
    ...
    private void initList(List<GroupDynamic> datas) {
        if (adapter == null) {
            ...
            adapter.setDefaultClickLinsener(new DefaultClickLinsener() {
                @Override
                public void onClick(View view, int position, Object item) {
                    //SimulatedTradingFragment.startAct(getActivity(), (ArrayList) adapter.getDatas(), position, true);
                }
            });
