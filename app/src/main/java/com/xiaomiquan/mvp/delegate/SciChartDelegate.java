...
//public class SciChartDelegate extends BaseDelegate {
...
//        viewHolder.tv_kvolume.setText(CommonUtils.getString(R.string.str_kvolume) + data.getKLineDatas().get(position).getVolume());
//
//    }
//
//
...
//            this.combinedchart = (SciChartSurface) rootView.findViewById(R.id.combinedchart);
...
//            this.barchart = (SciChartSurface) rootView.findViewById(R.id.barchart);
