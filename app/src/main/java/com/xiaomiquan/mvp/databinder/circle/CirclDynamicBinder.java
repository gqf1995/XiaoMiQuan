...
public class CirclDynamicBinder extends BaseDataBind<BaseFragentPullDelegate> {

    public CirclDynamicBinder(BaseFragentPullDelegate viewDelegate) {
        super(viewDelegate);
    }
    ...
    public Disposable getMoreCircle(
            int pageNum, int pageSize,
            RequestCallback requestCallback) {
        getBaseMapWithUid();
        baseMap.put("pageNum", 1);
