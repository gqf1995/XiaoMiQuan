package com.xiaomiquan.widget.editcodeview;
...
public class EditCodeView extends View
    ...
    private void initDefaultAttrs(Context context) {
        ...
        underlineStrokeWidth = resources.getDimension(R.dimen.text_trans_4px);
        underlineBaseColor = ContextCompat.getColor(context, R.color.color_font2);
    ...
    private void measureSizes(int viewWidth, int viewHeight) {
        if (underlineReductionScale > 1)
            underlineReductionScale = 1;
        if (underlineReductionScale < 0)
            underlineReductionScale = 0;
