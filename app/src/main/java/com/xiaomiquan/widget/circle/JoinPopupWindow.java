...
public class JoinPopupWindow extends PopupWindow implements View.OnClickListener {

    private LinearLayout lin_join, lin_creat;
    ...
    private void init(Context context) {
        ...
        //绑定布局
        mPopView = inflater.inflate(R.layout.popup_join_circle_layout, null);

        lin_join = (LinearLayout) mPopView.findViewById(R.id.lin_join);
        lin_creat = (LinearLayout) mPopView.findViewById(R.id.lin_creat);
