...
import com.xiaomiquan.entity.bean.circle.FavortItem;
import com.xiaomiquan.spannable.CircleMovementMethod;
import com.xiaomiquan.spannable.SpannableClickable;
...
public class PraiseListView extends android.support.v7.widget.AppCompatTextView{
    ...
    private SpannableString setImageSpan(){
        ...
        imgSpanText.setSpan(new ImageSpan(Application.getContext(), R.drawable.iconomi, DynamicDrawableSpan.ALIGN_BASELINE),
