...
public class Rise24ChangeSort implements Comparator<ExchangeData> {
    @Override
    public int compare(ExchangeData exchangeData, ExchangeData t1) {
        ...
        int thislv = new BigDecimal(t1.getPercentChange24h()).compareTo(new BigDecimal(exchangeData.getPercentChange24h()));
        return thislv;
    }
}
